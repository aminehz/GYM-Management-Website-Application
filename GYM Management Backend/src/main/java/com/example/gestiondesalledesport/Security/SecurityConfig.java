...
//       // httpSecurity.authorizeHttpRequests(authorize->authorize.requestMatchers("/addUser/**").permitAll());
//        httpSecurity.authorizeHttpRequests(authorize->authorize.requestMatchers("/admin/**").hasAuthority("ADMIN"));
//        httpSecurity.authorizeHttpRequests(authorize->authorize.requestMatchers("/member/**").hasAuthority("MEMBER"));
//        httpSecurity.authorizeHttpRequests(authorize->authorize.requestMatchers("/trainer/**").hasAuthority("TRAINER"));
